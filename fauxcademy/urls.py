...
urlpatterns = [
    ...
    path("<str:username>/<str:listname>/results/", views.viewResults, name="view_results"),
    path("<str:username>/<str:listname>/dashboard/", views.dashboard, name="dashboard"),
    path("<str:username>/<str:listname>/reveal_results/", views.revealResults, name="reveal_results"),
